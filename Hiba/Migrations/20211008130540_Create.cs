    ...
    public partial class Create : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_AddToYourInformationTags", x => x.ID);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Secound = table.Column<bool>(type: "bit", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_LectureWorkshops", x => x.ID);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Lang = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    AddToYourInformationTagID = table.Column<int>(type: "int", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_AddToYourInformation", x => x.ID);
                    table.ForeignKey(
                        name: "FK_AddToYourInformation_AddToYourInformationTags_AddToYourInformationTagID",
                        column: x => x.AddToYourInformationTagID,
                        principalTable: "AddToYourInformationTags",
                        principalColumn: "ID",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_AddToYourInformation_AddToYourInformationTagID",
                table: "AddToYourInformation",
                column: "AddToYourInformationTagID");
